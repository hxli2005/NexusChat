...
const (
	...
	UserService_CheckFriendship_FullMethodName        = "/user.v1.UserService/CheckFriendship"
	UserService_CheckMembership_FullMethodName        = "/user.v1.UserService/CheckMembership"
	UserService_GetConversationMembers_FullMethodName = "/user.v1.UserService/GetConversationMembers"
)
...
func (c *userServiceClient) CheckMembership(ctx context.Context, in *CheckMembershipRequest, opts ...grpc.CallOption) (*CheckMembershipResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckMembershipResponse)
	err := c.cc.Invoke(ctx, UserService_CheckMembership_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) GetConversationMembers(ctx context.Context, in *GetConversationMembersRequest, opts ...grpc.CallOption) (*GetConversationMembersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetConversationMembersResponse)
	err := c.cc.Invoke(ctx, UserService_GetConversationMembers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServiceServer) CheckMembership(context.Context, *CheckMembershipRequest) (*CheckMembershipResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckMembership not implemented")
}
func (UnimplementedUserServiceServer) GetConversationMembers(context.Context, *GetConversationMembersRequest) (*GetConversationMembersResponse, error) {
...
func _UserService_CheckMembership_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckMembershipRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).CheckMembership(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_CheckMembership_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).CheckMembership(ctx, req.(*CheckMembershipRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _UserService_GetConversationMembers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetConversationMembersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).GetConversationMembers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_GetConversationMembers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetConversationMembers(ctx, req.(*GetConversationMembersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserService_CheckMembership_Handler,
		},
		{
			MethodName: "GetConversationMembers",
			Handler:    _UserService_GetConversationMembers_Handler,
		},
	},
